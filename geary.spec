...
Source0  : https://download.gnome.org/sources/geary/3.36/geary-3.36.2.tar.xz
...
%prep
%setup -q -n geary-3.36.2
cd %{_builddir}/geary-3.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590423481
...
cp %{_builddir}/geary-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/geary/bef3bc6935e2bf6b3a78ce0d73b13cac7522b62c
cp %{_builddir}/geary-3.36.2/COPYING.icons %{buildroot}/usr/share/package-licenses/geary/69f06a48b814026a77752db9908bca89c342ea89
cp %{_builddir}/geary-3.36.2/COPYING.pyyaml %{buildroot}/usr/share/package-licenses/geary/02f4ee02272b590193abf6302151a54e3055f503
cp %{_builddir}/geary-3.36.2/COPYING.snowball %{buildroot}/usr/share/package-licenses/geary/360dcb3c1c6b4a67f33b3dc06b8d7b2a2b220f60
