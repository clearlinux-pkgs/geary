...
Version  : 3.36.3.1
Release  : 12
URL      : https://download.gnome.org/sources/geary/3.36/geary-3.36.3.1.tar.xz
Source0  : https://download.gnome.org/sources/geary/3.36/geary-3.36.3.1.tar.xz
...
%prep
%setup -q -n geary-3.36.3.1
cd %{_builddir}/geary-3.36.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598637881
...
cp %{_builddir}/geary-3.36.3.1/COPYING %{buildroot}/usr/share/package-licenses/geary/bef3bc6935e2bf6b3a78ce0d73b13cac7522b62c
cp %{_builddir}/geary-3.36.3.1/COPYING.icons %{buildroot}/usr/share/package-licenses/geary/69f06a48b814026a77752db9908bca89c342ea89
cp %{_builddir}/geary-3.36.3.1/COPYING.pyyaml %{buildroot}/usr/share/package-licenses/geary/02f4ee02272b590193abf6302151a54e3055f503
cp %{_builddir}/geary-3.36.3.1/COPYING.snowball %{buildroot}/usr/share/package-licenses/geary/360dcb3c1c6b4a67f33b3dc06b8d7b2a2b220f60
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/geary/libgeary-client-3.36.so
