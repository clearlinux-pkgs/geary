...
%prep
%setup -q -n geary-46.0
cd %{_builddir}/geary-46.0
pushd ..
cp -a geary-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716829054
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dprofile=release  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dprofile=release  builddiravx2
...
/usr/share/help/ru/geary/accounts.page
/usr/share/help/ru/geary/archive.page
/usr/share/help/ru/geary/bugs.page
/usr/share/help/ru/geary/contributing.page
/usr/share/help/ru/geary/figures/geary.svg
/usr/share/help/ru/geary/index.page
/usr/share/help/ru/geary/label.page
/usr/share/help/ru/geary/limits.page
/usr/share/help/ru/geary/overview.page
/usr/share/help/ru/geary/preferences.page
/usr/share/help/ru/geary/search.page
/usr/share/help/ru/geary/shortcuts.page
/usr/share/help/ru/geary/star.page
/usr/share/help/ru/geary/write.page
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/geary/libgeary-client-46.0.so
...
/usr/lib64/geary/libgeary-client-46.0.so
