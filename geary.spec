...
Version  : 3.36.1
Release  : 10
URL      : https://download.gnome.org/sources/geary/3.36/geary-3.36.1.tar.xz
Source0  : https://download.gnome.org/sources/geary/3.36/geary-3.36.1.tar.xz
...
%package dev
Summary: dev components for the geary package.
Group: Development
Requires: geary-lib = %{version}-%{release}
Requires: geary-bin = %{version}-%{release}
Requires: geary-data = %{version}-%{release}
Provides: geary-devel = %{version}-%{release}
Requires: geary = %{version}-%{release}

%description dev
dev components for the geary package.
...
%prep
%setup -q -n geary-3.36.1
cd %{_builddir}/geary-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585768282
...
cp %{_builddir}/geary-3.36.1/COPYING %{buildroot}/usr/share/package-licenses/geary/bef3bc6935e2bf6b3a78ce0d73b13cac7522b62c
cp %{_builddir}/geary-3.36.1/COPYING.icons %{buildroot}/usr/share/package-licenses/geary/69f06a48b814026a77752db9908bca89c342ea89
cp %{_builddir}/geary-3.36.1/COPYING.pyyaml %{buildroot}/usr/share/package-licenses/geary/02f4ee02272b590193abf6302151a54e3055f503
cp %{_builddir}/geary-3.36.1/COPYING.snowball %{buildroot}/usr/share/package-licenses/geary/360dcb3c1c6b4a67f33b3dc06b8d7b2a2b220f60
